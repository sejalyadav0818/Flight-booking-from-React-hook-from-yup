...
console.log("codddddddddddddddddd",dataa);
        ...
        <tbody>
          ...
          {currentRecords.map((item) => (
            <tr>
              ...
              <td>
                {item.basicDetails?.address.street }
              </td>
              <td>
                {item.basicDetails?.address.state}
              </td>
              <td>
                {item.basicDetails?.address.city}
              </td>
              <td>
                {item.basicDetails?.address.zipCode }
              </td>
              <td>
                {item.basicDetails?.gender }
              </td>
              <td>
                <button class="btn btn-dark">
                    <Link
                      to={
                        Array.isArray(item) ? `/?id=${item[0].id}` :
                        `/?id=${item.id}`
                      }>   Edit   </Link>
                </button>
              </td>
                ...
                <button
                  ...
                  onClick={() =>
                    handleDelete(Array.isArray(item) ? item[0].id : item.id)
                  }>
                  Delete
                </button>
              </td>
